...
function SendBoundaryZ(U::CuParVector2D{T},comm,buff_Z_1::CuArray{T},buff_Z_2::CuArray{T}) where T
    CUDA.@sync begin
    ...
    MPI.Isend(buff_Y_1,rank_source_up,0,comm)                
    MPI.Isend(buff_Y_2,rank_source_down,1,comm)              
end
